            ...
            <div>
              ...
              <div className="space-y-2 bg-[#fff7f9] p-3.5 rounded-2xl border border-[#f3d7df] mb-4 text-xs text-[#3d2530]">
                <div className="flex items-start gap-2">
                  <Package className="w-4 h-4 text-[#e05d82] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  <Clock className="w-4 h-4 text-[#ff7e67] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  <Layers className="w-4 h-4 text-[#4d8b74] shrink-0 mt-0.5" />
                  <div>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 text-xs text-[#4a2e3a]">
                    {product.includedItems.map((inc, i) => (
                      <li key={i} className="flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#4d8b74] shrink-0" />
                        <span>{inc}</span>
                      </li>
                    ))}
                  </ul>
